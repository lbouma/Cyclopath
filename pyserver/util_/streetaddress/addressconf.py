...
class Directions(object):
   ...
   # Python <2.7:
   DIRECTIONAL_CODES = dict(zip(DIRECTIONAL.values(), DIRECTIONAL.keys()))
...
class Streets(object):
   STREET_TYPES = {
      ...
      "tracks":"trak",
      "trafficway":"trfy",
      # Cyclopath: Don't Change "Trail", i.e., Bike Trail better than Bike Trl.
      #"trail":"trl",
      "trl":"trail",
      "trails":"trl",
      "trk":"trak",
...
class States(object):
   ...
   # Python <2.7:
   STATE_NAMES = dict(zip(STATE_CODES.values(), STATE_CODES.keys()))
   ...
   # Python <2.7:
   FIPS_STATES = dict(zip(STATE_FIPS.values(), STATE_FIPS.keys()))
