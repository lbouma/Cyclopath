...
package {
   ...
   public class Conf_Instance {
      ...
      public static const config:Object = {
         ...
         'http://TARGETHOST().cyclopath.org': config_mn,
         ...
         //'http://dev': config_mn,
         //'http://dev.cs.umn.edu': config_mn,
         //'http://dev.cs.umn.edu:8081': config_mn,
         //'http://dev.cs.umn.edu:8082': config_mn,
         //'http://dev.cs.umn.edu:8083': config_mn,
         //'http://dev.cs.umn.edu:8084': config_mn,
         //'http://dev.cs.umn.edu:8085': config_mn,

         // == For DEVs debugging via ssh -L ==
         'http://localhost:HTTPD_PORT_NUM()': config_mn
         //'http://127.0.0.1:HTTPD_PORT_NUM()': config_mn
         //'http://SERVERMACHINE():HTTPD_PORT_NUM()': config_mn
         //'http://SERVERMACHINE().TARGETDOMAIN():HTTPD_PORT_NUM()': config_mn
     ...
     // http://wiki.grouplens.org/index.php/Cyclopath/Production_and_Deployment
      ...
      //public static const url_base:String = 'http://my.domain.org';
      //public static const url_base:String = 'http://host.domain.org:8084';
      //public static const url_base:String = 'http://localhost:8084';
      // DEVS: Set the port (e.g., 8084) to your SSH -L mapped port
      //       of the remote pyserver.
      //public static const url_base_if_file:String =
      //   'http://TARGETHOST().cs.umn.edu:HTTPD_PORT_NUM()';
      // This won't happen, but nonetheless:
      public static const url_base_if_file:String =
         'http://TARGETHOST().cyclopath.org';
      ...
      public static const debug_logging_level_default:String = 'INFO';
      public static const debug_logging_level_override:Boolean = true;
