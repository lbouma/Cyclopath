...
syn keyword actionScriptObjects				arguments Array Boolean Date _global Math Number Object String super var const this Accessibility Color Key _level Mouse _root Selection Sound Stage System TextFormat LoadVars XML XMLSocket XMLNode LoadVars Button TextField TextSnapshot CustomActions Error ContextMenu ContextMenuItem NetConnection NetStream Video PrintJob MovieClipLoader StyleSheet Camera LocalConnection Microphone SharedObject MovieClip
...
" Added 2010.12.08
" Make inline.@xml stand out
" FIXME This works but it wastes lots of cycles and makes normal VIM operation slow
"syn match   actionScriptXMLNameSkip			"@"
"syn match   actionScriptXMLNameSkip2			"[\(\),;\t\r\n]"
"syn region  actionScriptXMLName	start=+@+    end=+[\(\),; \t\r\n]+ contains=actionScriptXMLNameSkip,actionScriptXMLNameSkip2,actionScriptCharacter,actionScriptNumber
" FIXME This was uncommented on Huffy: does it work?:
"syn match   actionScriptXMLNameSkip			"@"
"syn match   actionScriptXMLNameSkip2			"[\(\); \t\r\n]"
"syn region  actionScriptXMLName	start=+@+    end=+[\(\); \t\r\n]+ contains=actionScriptXMLNameSkip,actionScriptXMLNameSkip2,actionScriptCharacter,actionScriptNumber
...
"  HiLink actionScriptXMLName		DiffChange
  HiLink actionScriptXMLName		Statement
