...
\          'ConvolutionFilter':
\              [ [], {'alpha': [],'bias': [],'clamp': [],'color': [],'divisor': [],'id': [],'matrixX': [],'matrixY': [],'preserveAlpha': []} ]
\         ,'DisplacementMapFilter':
\              [ [], {'alpha': [],'color': [],'componentX': [],'componentY': [],'id': [],'mapBitmap': [],'mapPoint': [],'mode': [],'scaleX': [],'scaleY': []} ]
\         ,'ShaderFilter':
\              [ [], {'bottomExtension': [],'id': [],'leftExtension': [],'rightExtension': [],'shader': [],'topExtension': []} ]
\ }
