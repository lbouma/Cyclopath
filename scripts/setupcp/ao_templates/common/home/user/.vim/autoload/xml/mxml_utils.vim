...
\          'ByteArray':
\              [ [], {'bytesAvailable': [],'defaultObjectEncoding': [],'endian': [],'id': [],'length': [],'objectEncoding': [],'position': []} ]
\         ,'Dictionary':
\              [ [], {'id': []} ]
\         ,'Timer':
\              [ [], {'activate': [],'currentCount': [],'deactivate': [],'delay': [],'id': [],'repeatCount': [],'running': [],'timer': [],'timerComplete': []} ]
\ }
