" Mod_Author:  Landon Bouma
" Last Change: Thu 17 Jun 2010 10:14:08 AM CDT
" Version:     1.4.2
...
function! s:Project(filename) " <<<
    ...
    function! s:DoSetupAndSplit()
        ...
        silent! wincmd p
        let n = winnr()
        " [lb] Previous window is project window, so find new window
        " NOTE We can't just move one window right, like this:
        "if n == winnr()
        "    silent! wincmd l
        "endif
    ...
    function! s:CreateEntriesFromDir(recursive)
        ...
        " Do the work
        call s:DoEntryFromDir(a:recursive, line, name, home.dir, dir, c_d, filter_directive, filter, exclude_directive, exclude, foldlev, 0)
