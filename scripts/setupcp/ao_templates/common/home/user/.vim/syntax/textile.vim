...
" [lb] 2009.09.04 Two dots means extended block;
"                 Also, space must follow!
"syn match txtBlockquote  /^bq\./
syn match txtBlockquote  /^bq\.\{1,2} /
" [lb] 2009.09.04 RedCloth supports block code, too!
syn match txtBlockCode   /^bc\.\{1,2} /
